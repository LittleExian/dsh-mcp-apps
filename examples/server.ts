...
const html='<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MCP Apps Host demo</title><style>body{margin:0;background:#fff;color:#24362d;font:15px/1.5 system-ui}main{max-width:960px;margin:0 auto;padding:16px}h1{font-size:22px}pre{font-size:13px}*{box-sizing:border-box}</style></head><body><main><h1>MCP Apps · DSH host</h1><p>Real MCP server → retained result → double iframe → tool callback</p><div id="root"></div></main><script type="module" src="/harness.js"></script></body></html>'
