...
使用左右方向键或 Page Up / Page Down 翻页，按 `R` 重播当前页，按 `O` 打开全部章节。每页加载后会独立开始动画，不依赖统一时间轴。
...
~~~bash
python3 -m http.server 43190
~~~

打开 <code>http://127.0.0.1:43190/docs/mcp-apps-runtime-animation/</code>。
