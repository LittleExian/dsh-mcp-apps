...
for (const width of [360, 1040]) {
  test(`GitHub Trending MCP App loads and refreshes at ${width}px`, async ({ page }) => {
    ...
    await page.screenshot({ path: `test-results/github-trending-${width}.png`, fullPage: true })
  })
}
